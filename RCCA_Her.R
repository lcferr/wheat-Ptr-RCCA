...
met0 <- read.csv("her_DAM.csv", header = TRUE)
gen0 <- read.csv("her_DEG.csv", header = TRUE)
...
met$H29T48R1 <- rowMeans(subset(met, select = c(Her_I_T48, Her_I_T48.1, Her_I_T48.2, Her_I_T48.3)), na.rm=T)
met$H29T48R2 <- rowMeans(subset(met, select = c(Her_I_T48.4, Her_I_T48.5, Her_I_T48.6, Her_I_T48.7)), na.rm=T)
met$H29T48R3 <- rowMeans(subset(met, select = c(Her_I_T48.8, Her_I_T48.9, Her_I_T48.10, Her_I_T48.11)), na.rm=T)

met$HMT48R1 <- rowMeans(subset(met, select = c(Her_M_T48, Her_M_T48.1, Her_M_T48.2, Her_M_T48.3)), na.rm=T)
met$HMT48R2 <- rowMeans(subset(met, select = c(Her_M_T48.4, Her_M_T48.5, Her_M_T48.6, Her_M_T48.7)), na.rm=T)
met$HMT48R3 <- rowMeans(subset(met, select = c(Her_M_T48.8, Her_M_T48.9, Her_M_T48.10, Her_M_T48.11)), na.rm=T)

met$H29T96R1 <- rowMeans(subset(met, select = c(Her_I_T96, Her_I_T96.1, Her_I_T96.2, Her_I_T96.3)), na.rm=T)
met$H29T96R2 <- rowMeans(subset(met, select = c(Her_I_T96.4, Her_I_T96.5, Her_I_T96.6, Her_I_T96.7)), na.rm=T)
met$H29T96R3 <- rowMeans(subset(met, select = c(Her_I_T96.8, Her_I_T96.9, Her_I_T96.10, Her_I_T96.11)), na.rm=T)

met$HMT96R1 <- rowMeans(subset(met, select = c(Her_M_T96, Her_M_T96.1, Her_M_T96.2, Her_M_T96.3)), na.rm=T)
met$HMT96R2 <- rowMeans(subset(met, select = c(Her_M_T96.4, Her_M_T96.5, Her_M_T96.6, Her_M_T96.7)), na.rm=T)
met$HMT96R3 <- rowMeans(subset(met, select = c(Her_M_T96.8, Her_M_T96.9, Her_M_T96.10)), na.rm=T)


#SUBSET THE COLUMNS WE JUST CREATED

Y0 <- met %>% select(grep("X", names(met)), grep("HM", names(met)), grep("H29", names(met)))
...
write.csv(Y0, "her_metabolites_avgintensity.csv", row.names = T)
...
write.graph(myNetwork.rcc$gR, file = "herrccnetworkXY.gml", format = "gml")
